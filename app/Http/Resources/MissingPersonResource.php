...
class MissingPersonResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'picture_link' => route('admin.viewFiles', [ 'folderName' => 'missing-pictures', 'fileName' => $this->picture_name ? $this->picture_name : '',]),
            'credential_link' => route('admin.viewFiles', [ 'folderName' => 'credentials', 'fileName' => $this->credential_name ? $this->credential_name : '',]),
