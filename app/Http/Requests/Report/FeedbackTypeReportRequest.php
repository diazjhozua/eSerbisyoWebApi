...
class FeedbackTypeReportRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'sort_column' => ['required', Rule::in(['id', 'name', 'feedbacks_count', 'positive_count', 'neutral_count', 'negative_count','created_at', 'updated_at'])],
