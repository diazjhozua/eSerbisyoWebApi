...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('command:ignore_feedback')->dailyAt('03:00');
        $schedule->command('command:ignore_report')->dailyAt('03:00');
        $schedule->command('command:order')->dailyAt('03:00');
