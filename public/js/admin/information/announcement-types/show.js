...
$(document).ready(function () {
    ...
    $("form[name='reportForm']").validate({
        ...
        submitHandler: function (form, event) {
            ...
            var url = `${window.location.origin}/admin/announcement-types/report/${date_start}/${date_end}/${sort_column}/${sort_option}/${type_id}`;
            ...
            //         link.download = "AnnouncementTypeProfileReport-" + Date.now() + ".pdf";
            //         link.click();
