        ...
        submitHandler: function (form, event) {
            ...
            doAjax(formAction, 'POST', formData).then((response) => {
                if (response.success) {
                    ...
                    col3 = '<td><a href="' + window.location.origin + '/files/documents/' + data.pdf_name + '">' + data.pdf_name + '</a></td>'
                    ...
                    if (formMethod == 'POST') {
                        ...
                        table.row.add([col1, col2, col3, col4, col5]).draw()
                        ...
                        if (parseInt(currentTypeID[1]) != parseInt(data.type_id)) {
                            ...
                            table.row('.selected').data([col1, col2, col3, col4, col5]).draw(false);
                        }
                    }
                }
