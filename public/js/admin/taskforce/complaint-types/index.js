...
$(document).ready(function () {
    ...
    // Initialize Year picker in complaint form
        ...
        submitHandler: function (form, event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    col2 = '<td>' + data.complaints_count + '</td>'
                    col3 = '<td>' + data.updated_at + '</td>'

                    viewBtn =
                        '<li class="list-inline-item mb-1">' +
                        '<a class="btn btn-info btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="View" href="' + window.location.origin + '/admin/complaint-types/' + data.id + '"><i class="fas fa-eye"></i>' +
                        '</a></li>'
                    editBtn =
                        '<li class="list-inline-item mb-1">' +
