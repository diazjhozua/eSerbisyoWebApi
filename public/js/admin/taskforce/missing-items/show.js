...
function populateAllFields(data, reportTypes) {
    ...
    $('#currentCredential').prop('href', data.credential_path); //add the src attribute
...
function editReport(id) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            populateAllFields(data, reportTypes);
...
function changeStatusReport(id) {
    ...
    let actionURL = window.location.origin + '/admin/missing-items/change-status/' + id;
