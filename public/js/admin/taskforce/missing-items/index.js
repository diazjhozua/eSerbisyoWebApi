...
function addOrReplaceData(data, addOrReplace) {
    ...
    col5 = '<td>' + data.description + ' yr old</td>';
    ...
    viewBtn =
        ...
        '<a class="btn btn-info btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="View" href="' + window.location.origin + '/admin/missing-items/' + data.id + '"><i class="fas fa-eye"></i>' +
        '</a></li>'
