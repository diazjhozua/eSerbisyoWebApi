...
@section('page-js')
    ...
    <script src="{{ asset('js/admin/information/announcements/show.js')}}"></script>
...
@section('content')
    ...
    @include('admin.information.announcements.picture-form')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.announcements.reportProfile', $announcement->id) }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" target="_blank">
