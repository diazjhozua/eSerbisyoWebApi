            ...
            <form name="reportForm" id="reportForm" action="" method="POST" novalidate>
                <div class="modal-body">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group mb-3">
                                <select class="custom-select" id="sort_column" name="sort_column">
                                    ...
                                    <option value="location_address">Location</option>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            {{-- Sort by column option --}}
                            <label for="project_start" class="form-label">Show Only (Classification):</label>
                            <div class="input-group mb-3">
                                <select class="custom-select" id="classification_option" name="classification_option">
